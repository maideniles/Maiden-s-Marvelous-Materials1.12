...
import com.maideniles.maidensmaterials.world.feature.tree.WorldGenCrabappleTreeVines;
...
public class BlockCrabappleSaplingVines
  extends BlockBush
  implements IGrowable
{
  ...
  public BlockCrabappleSaplingVines(String name){
  ...
  public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
  {
    ...
    IBlockState LOG = MaidensBlocks.log_crabapple.getDefaultState();
    IBlockState LEAF = MaidensBlocks.leaves_crabapple.getDefaultState();
    WorldGenerator worldgenerator = new WorldGenCrabappleTreeVines(false);
