...
public class BlockFlowerVaseCyan extends Block{
	...
	public BlockFlowerVaseCyan(String name, Material materialIn) {
		super(Material.CLAY);
	...
	public static Item getFlowerFromID(int id) {
	 ...
	 public Item getItemDropped(IBlockState state, Random rand, int fortune)
	    {
	        return Item.getItemFromBlock(MaidensBlocks.vase_cyan);
	    }
	 ...
	 @Override
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos,
			...
			return new ItemStack(Item.getItemFromBlock(MaidensBlocks.vase_cyan));
		}
