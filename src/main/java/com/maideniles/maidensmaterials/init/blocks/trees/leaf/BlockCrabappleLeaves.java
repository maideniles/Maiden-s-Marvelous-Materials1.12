...
public class BlockCrabappleLeaves extends BlockLeaves
{
    public BlockCrabappleLeaves(String name)
    {
    ...
    protected void dropApple(World worldIn, BlockPos pos, IBlockState state, int chance)
    {
        ...
        {
            spawnAsEntity(worldIn, pos, new ItemStack(Item.getItemFromBlock(BlockInit.sapling_crabapple_vines)));
        }
    }
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
    	...
    	return Item.getItemFromBlock(BlockInit.sapling_crabapple);
    }
...
mainHandItem.setDamage(mainHandItemStack, mainHandItem.getDamage(mainHandItemStack) + 1);
                ...
                EntityItem itemblossoms = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(MaidensItems.crabapple_blossoms, 1));
