...
public class BlockJacarandaLeaves extends BlockLeaves
{
    ...
    protected void dropApple(World worldIn, BlockPos pos, IBlockState state, int chance)
    {
        ...
        {
            spawnAsEntity(worldIn, pos, new ItemStack(Item.getItemFromBlock(BlockInit.sapling_jacaranda_vines)));
        }
    }
    ...
    {
        return Item.getItemFromBlock(BlockInit.sapling_jacaranda);
    }
