...
import com.maideniles.maidensmaterials.world.feature.tree.WorldGenSilverBellTreeVines;
...
public class BlockSilverBellSaplingVines
  extends BlockBush
  implements IGrowable
{
  ...
  public BlockSilverBellSaplingVines(String name){
  ...
  public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
  {
    ...
    IBlockState LOG = MaidensBlocks.log_silverbell.getDefaultState();
    IBlockState LEAF = MaidensBlocks.leaves_silverbell.getDefaultState();
    WorldGenerator worldgenerator = new WorldGenSilverBellTreeVines(false);
