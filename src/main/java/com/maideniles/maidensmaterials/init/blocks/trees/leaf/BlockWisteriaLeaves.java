...
public class BlockWisteriaLeaves extends BlockLeaves
{
    public BlockWisteriaLeaves(String name)
    {
    ...
    protected void dropApple(World worldIn, BlockPos pos, IBlockState state, int chance)
    {
        ...
        {
            spawnAsEntity(worldIn, pos, new ItemStack(Item.getItemFromBlock(BlockInit.sapling_wisteria_vines)));
        }
    }
    ...
    {
        return Item.getItemFromBlock(BlockInit.sapling_wisteria);
    }
