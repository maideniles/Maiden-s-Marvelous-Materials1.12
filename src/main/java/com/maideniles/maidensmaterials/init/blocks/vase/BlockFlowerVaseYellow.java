...
public class BlockFlowerVaseYellow extends Block{
	...
	public BlockFlowerVaseYellow(String name, Material materialIn) {
		super(Material.CLAY);
	...
	public static Item getFlowerFromID(int id) {
	 ...
	 public Item getItemDropped(IBlockState state, Random rand, int fortune)
	    {
	        return Item.getItemFromBlock(MaidensBlocks.vase_yellow);
	    }
	 ...
	 @Override
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos,
			...
			return new ItemStack(Item.getItemFromBlock(MaidensBlocks.vase_yellow));
		}
