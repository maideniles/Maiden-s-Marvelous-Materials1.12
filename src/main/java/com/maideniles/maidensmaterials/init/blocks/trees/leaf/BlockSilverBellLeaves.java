...
public class BlockSilverBellLeaves extends BlockLeaves
{
    ...
    protected void dropApple(World worldIn, BlockPos pos, IBlockState state, int chance)
    {
        ...
        {
            spawnAsEntity(worldIn, pos, new ItemStack(Item.getItemFromBlock(BlockInit.sapling_silverbell_vines)));
        }
    }
    ...
    {
        return Item.getItemFromBlock(BlockInit.sapling_silverbell);
    }
