...
public class BlockSilverBellLeaves extends BlockLeaves
{
    public BlockSilverBellLeaves(String name)
    {
    ...
    protected void dropApple(World worldIn, BlockPos pos, IBlockState state, int chance)
    {
        ...
        {
            spawnAsEntity(worldIn, pos, new ItemStack(Item.getItemFromBlock(MaidensBlocks.sapling_silverbell_vines)));
        }
    }
    ...
    {
        return Item.getItemFromBlock(MaidensBlocks.sapling_silverbell);
    }
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (mainHandItem == MaidensItems.pruning_shears || playerIn.isPotionActive(MaidensMaterials.FLORAL_FORTUNE)) {
			if (!worldIn.isRemote) {
				...
				EntityItem itemblossoms = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(),new ItemStack(MaidensItems.silverbell_blossoms, 1));
