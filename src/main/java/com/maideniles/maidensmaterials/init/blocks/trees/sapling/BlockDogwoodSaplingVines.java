...
import com.maideniles.maidensmaterials.world.feature.tree.WorldGenDogwoodTreeVines;
...
public class BlockDogwoodSaplingVines
  extends BlockBush
  implements IGrowable
{
  ...
  public BlockDogwoodSaplingVines(String name){
  ...
  public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
  {
    ...
    WorldGenerator worldgenerator = new WorldGenDogwoodTreeVines(false);
