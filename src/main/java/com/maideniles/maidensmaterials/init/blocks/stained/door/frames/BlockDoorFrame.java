...
public class BlockDoorFrame extends BlockFinishingsBase{
	
	
	protected static final AxisAlignedBB AABB = new AxisAlignedBB(-0.25D, 0.0D, 0.0D, 0.0D, 1.0D, 0.18D);
	protected static final AxisAlignedBB TOP_AABB = new AxisAlignedBB(-0.25D, 0.0D, 0.0D, 1.25D, 0.25D, 0.18D);

	public BlockDoorFrame(String name, Material material) {
		super(material);
