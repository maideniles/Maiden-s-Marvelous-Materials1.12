...
import com.maideniles.maidensmaterials.world.feature.tree.WorldGenJacarandaTreeVines;
...
public class BlockJacarandaSaplingVines
  extends BlockBush
  implements IGrowable
{
  ...
  public BlockJacarandaSaplingVines(String name){
  ...
  public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
  {
    ...
    IBlockState LOG = MaidensBlocks.log_jacaranda.getDefaultState();
    IBlockState LEAF = MaidensBlocks.leaves_jacaranda.getDefaultState();
    WorldGenerator worldgenerator = new WorldGenJacarandaTreeVines(false);
