...
//TODO
{
	...
	public static Block crabapple_cobblestone, dogwood_cobblestone, jacaranda_cobblestone, laburnum_cobblestone,
			paulownia_cobblestone, silverbell_cobblestone, wisteria_cobblestone;
	public static Block amethyst_block, aventurine_block, carnelian_block, chalcopyrite_block, citrine_block,
			jade_block, jasper_block, labradorite_block, mica_block, moonstone_block, rose_quartz_block, sodalite_block;
	public static Block amethyst_tile_1, amethyst_tile_2, amethyst_tile_3, amethyst_tile_4, amethyst_tile_5,
			amethyst_tile_6;
	public static Block chalcopyrite_tile_1, chalcopyrite_tile_2, chalcopyrite_tile_3, chalcopyrite_tile_4,
			chalcopyrite_tile_5, chalcopyrite_tile_6;
	...
	public static Block labradorite_tile_1, labradorite_tile_2, labradorite_tile_3, labradorite_tile_4,
			labradorite_tile_5, labradorite_tile_6;
	public static Block moonstone_tile_1, moonstone_tile_2, moonstone_tile_3, moonstone_tile_4, moonstone_tile_5,
			moonstone_tile_6;
	public static Block rose_quartz_tile_1, rose_quartz_tile_2, rose_quartz_tile_3, rose_quartz_tile_4,
			rose_quartz_tile_5, rose_quartz_tile_6;
	public static Block sodalite_tile_1, sodalite_tile_2, sodalite_tile_3, sodalite_tile_4, sodalite_tile_5,
			sodalite_tile_6;
	public static Block citrine_tile_1, citrine_tile_2, citrine_tile_3, citrine_tile_4, citrine_tile_5, citrine_tile_6;
	public static Block aventurine_tile_1, aventurine_tile_2, aventurine_tile_3, aventurine_tile_4, aventurine_tile_5,
			aventurine_tile_6;
	public static Block carnelian_tile_1, carnelian_tile_2, carnelian_tile_3, carnelian_tile_4, carnelian_tile_5,
			carnelian_tile_6;

	public static Block red_clay_block, orange_clay_block, yellow_clay_block, lime_clay_block, green_clay_block,
			cyan_clay_block, light_blue_clay_block;
	public static Block blue_clay_block, purple_clay_block, magenta_clay_block, brown_clay_block, black_clay_block,
			gray_clay_block, light_gray_clay_block;
	public static Block white_clay_block, pink_clay_block;

	public static Block red_brick_block, orange_brick_block, yellow_brick_block, lime_brick_block, green_brick_block,
			cyan_brick_block, light_blue_brick_block;
	public static Block blue_brick_block, purple_brick_block, magenta_brick_block, brown_brick_block, black_brick_block,
			gray_brick_block, light_gray_brick_block;
	public static Block white_brick_block, pink_brick_block;

	public static Block red_brick_stairs, orange_brick_stairs, yellow_brick_stairs, lime_brick_stairs,
			green_brick_stairs, cyan_brick_stairs, light_blue_brick_stairs;
	public static Block blue_brick_stairs, purple_brick_stairs, magenta_brick_stairs, brown_brick_stairs,
			black_brick_stairs, gray_brick_stairs, light_gray_brick_stairs;
	...
	public static Block red_large_brick_block, orange_large_brick_block, yellow_large_brick_block,
			lime_large_brick_block, green_large_brick_block, cyan_large_brick_block, light_blue_large_brick_block;
	public static Block blue_large_brick_block, purple_large_brick_block, magenta_large_brick_block,
			brown_large_brick_block, black_large_brick_block, gray_large_brick_block, light_gray_large_brick_block;
	public static Block white_large_brick_block, pink_large_brick_block;

	public static Block red_large_brick_stairs, orange_large_brick_stairs, yellow_large_brick_stairs,
			lime_large_brick_stairs, green_large_brick_stairs, cyan_large_brick_stairs, light_blue_large_brick_stairs;
	public static Block blue_large_brick_stairs, purple_large_brick_stairs, magenta_large_brick_stairs,
			brown_large_brick_stairs, black_large_brick_stairs, gray_large_brick_stairs, light_gray_large_brick_stairs;
	...
	public static Block vase, vase_red, vase_orange, vase_yellow, vase_lime, vase_green, vase_cyan, vase_light_blue,
			vase_blue, vase_purple;
	...
	public static Block silverbell_planks, crabapple_planks, dogwood_planks, jacaranda_planks, wisteria_planks,
			whitewashed_planks, laburnum_planks, paulownia_planks;
	public static CustomBlockHalfSlab silverbell_slab_half, crabapple_slab_half, dogwood_slab_half, jacaranda_slab_half,
			wisteria_slab_half, whitewashed_slab_half, paulownia_slab_half, laburnum_slab_half, cedar_slab_half;
	public static CustomBlockDoubleSlab silverbell_slab_double, crabapple_slab_double, dogwood_slab_double,
			jacaranda_slab_double, wisteria_slab_double, whitewashed_slab_double, paulownia_slab_double,
			laburnum_slab_double, cedar_slab_double;
	public static Block silverbell_stairs, crabapple_stairs, dogwood_stairs, jacaranda_stairs, wisteria_stairs,
			whitewashed_stairs, paulownia_stairs, laburnum_stairs, cedar_stairs;
	public static Block silverbell_fence, crabapple_fence, dogwood_fence, jacaranda_fence, wisteria_fence,
			whitewashed_fence, paulownia_fence, laburnum_fence, cedar_fence;
	public static Block silverbell_fence_gate, crabapple_fence_gate, dogwood_fence_gate, jacaranda_fence_gate,
			wisteria_fence_gate, whitewashed_fence_gate, paulownia_fence_gate, laburnum_fence_gate, cedar_fence_gate;

	public static Block red_stained_trapdoor_1, orange_stained_trapdoor_1, yellow_stained_trapdoor_1,
			lime_stained_trapdoor_1, green_stained_trapdoor_1, cyan_stained_trapdoor_1, light_blue_stained_trapdoor_1;
	public static Block blue_stained_trapdoor_1, purple_stained_trapdoor_1, magenta_stained_trapdoor_1,
			pink_stained_trapdoor_1, white_stained_trapdoor_1, light_gray_stained_trapdoor_1, gray_stained_trapdoor_1;
	public static Block black_stained_trapdoor_1, brown_stained_trapdoor_1;

	public static Block red_stained_trapdoor_4, orange_stained_trapdoor_4, yellow_stained_trapdoor_4,
			lime_stained_trapdoor_4, green_stained_trapdoor_4, cyan_stained_trapdoor_4, light_blue_stained_trapdoor_4;
	public static Block blue_stained_trapdoor_4, purple_stained_trapdoor_4, magenta_stained_trapdoor_4,
			pink_stained_trapdoor_4, white_stained_trapdoor_4, light_gray_stained_trapdoor_4, gray_stained_trapdoor_4;
	public static Block black_stained_trapdoor_4, brown_stained_trapdoor_4;

	public static Block red_stained_door_1, orange_stained_door_1, yellow_stained_door_1, lime_stained_door_1,
			green_stained_door_1, cyan_stained_door_1, light_blue_stained_door_1;
	public static Block blue_stained_door_1, purple_stained_door_1, magenta_stained_door_1, pink_stained_door_1,
			white_stained_door_1, light_gray_stained_door_1, gray_stained_door_1;
	public static Block black_stained_door_1, brown_stained_door_1;

	public static Block red_stained_door_2, orange_stained_door_2, yellow_stained_door_2, lime_stained_door_2,
			green_stained_door_2, cyan_stained_door_2, light_blue_stained_door_2;
	public static Block blue_stained_door_2, purple_stained_door_2, magenta_stained_door_2, pink_stained_door_2,
			white_stained_door_2, light_gray_stained_door_2;
	public static Block gray_stained_door_2, black_stained_door_2, brown_stained_door_2;

	public static Block red_stained_door_3, orange_stained_door_3, yellow_stained_door_3, lime_stained_door_3,
			green_stained_door_3, cyan_stained_door_3, light_blue_stained_door_3;
	public static Block blue_stained_door_3, purple_stained_door_3, magenta_stained_door_3, pink_stained_door_3,
			white_stained_door_3, light_gray_stained_door_3;
	public static Block gray_stained_door_3, black_stained_door_3, brown_stained_door_3;

	public static Block red_stained_door_4, orange_stained_door_4, yellow_stained_door_4, lime_stained_door_4,
			green_stained_door_4, cyan_stained_door_4, light_blue_stained_door_4;
	public static Block blue_stained_door_4, purple_stained_door_4, magenta_stained_door_4, pink_stained_door_4,
			white_stained_door_4, light_gray_stained_door_4;
	public static Block gray_stained_door_4, black_stained_door_4, brown_stained_door_4;

	public static Block red_stained_door_5, orange_stained_door_5, yellow_stained_door_5, lime_stained_door_5,
			green_stained_door_5, cyan_stained_door_5, light_blue_stained_door_5;
	public static Block blue_stained_door_5, purple_stained_door_5, magenta_stained_door_5, pink_stained_door_5,
			white_stained_door_5, light_gray_stained_door_5;
	public static Block gray_stained_door_5, black_stained_door_5, brown_stained_door_5;

	public static Block red_stained_door_6, orange_stained_door_6, yellow_stained_door_6, lime_stained_door_6,
			green_stained_door_6, cyan_stained_door_6, light_blue_stained_door_6;
	public static Block blue_stained_door_6, purple_stained_door_6, magenta_stained_door_6, pink_stained_door_6,
			white_stained_door_6, light_gray_stained_door_6;
	...
	public static Block dark_oak_door_1, dark_oak_door_2, dark_oak_door_3, dark_oak_door_4, dark_oak_door_5,
			dark_oak_door_6;

	public static Block jungle_door_1, jungle_door_2, jungle_door_3, jungle_door_4, jungle_door_5, jungle_door_6;

	public static Block silverbell_door_1, silverbell_door_2, silverbell_door_3, silverbell_door_4, silverbell_door_5,
			silverbell_door_6;
	public static Block crabapple_door_1, crabapple_door_2, crabapple_door_3, crabapple_door_4, crabapple_door_5,
			crabapple_door_6;
	public static Block dogwood_door_1, dogwood_door_2, dogwood_door_3, dogwood_door_4, dogwood_door_5, dogwood_door_6;
	public static Block jacaranda_door_1, jacaranda_door_2, jacaranda_door_3, jacaranda_door_4, jacaranda_door_5,
			jacaranda_door_6;
	public static Block paulownia_door_1, paulownia_door_2, paulownia_door_3, paulownia_door_4, paulownia_door_5,
			paulownia_door_6;
	public static Block wisteria_door_1, wisteria_door_2, wisteria_door_3, wisteria_door_4, wisteria_door_5,
			wisteria_door_6;
	public static Block laburnum_door_1, laburnum_door_2, laburnum_door_3, laburnum_door_4, laburnum_door_5,
			laburnum_door_6;
	public static Block cedar_door_1, cedar_door_2, cedar_door_3, cedar_door_4, cedar_door_5, cedar_door_6;

	public static Block red_stained_stairs, orange_stained_stairs, yellow_stained_stairs, lime_stained_stairs,
			green_stained_stairs, cyan_stained_stairs, light_blue_stained_stairs;
	public static Block blue_stained_stairs, purple_stained_stairs, magenta_stained_stairs, brown_stained_stairs,
			black_stained_stairs, gray_stained_stairs, light_gray_stained_stairs;
	public static Block white_stained_stairs, pink_stained_stairs;

	public static Block red_stained_planks, orange_stained_planks, yellow_stained_planks, lime_stained_planks,
			green_stained_planks, cyan_stained_planks, light_blue_stained_planks;
	public static Block blue_stained_planks, purple_stained_planks, magenta_stained_planks, brown_stained_planks,
			black_stained_planks, gray_stained_planks, light_gray_stained_planks;
	public static Block white_stained_planks, pink_stained_planks;

	public static Block red_stained_bookshelf, orange_stained_bookshelf, yellow_stained_bookshelf,
			lime_stained_bookshelf, green_stained_bookshelf, cyan_stained_bookshelf, light_blue_stained_bookshelf;
	public static Block blue_stained_bookshelf, purple_stained_bookshelf, magenta_stained_bookshelf,
			brown_stained_bookshelf, black_stained_bookshelf, gray_stained_bookshelf;
	public static Block light_gray_stained_bookshelf, white_stained_bookshelf, pink_stained_bookshelf;
	public static Block cedar_bookshelf, crabapple_bookshelf, dogwood_bookshelf, jacaranda_bookshelf,
			laburnum_bookshelf, paulownia_bookshelf, silverbell_bookshelf, wisteria_bookshelf;
	public static Block acacia_bookshelf, birch_bookshelf, oak_bookshelf, spruce_bookshelf, dark_oak_bookshelf,
			jungle_bookshelf;
	...
	public static Block red_stained_fence, orange_stained_fence, yellow_stained_fence, lime_stained_fence,
			green_stained_fence, cyan_stained_fence, light_blue_stained_fence;
	public static Block blue_stained_fence, purple_stained_fence, magenta_stained_fence, brown_stained_fence,
			black_stained_fence, gray_stained_fence, light_gray_stained_fence;
	public static Block white_stained_fence, pink_stained_fence;

	public static Block red_stained_fence_gate, orange_stained_fence_gate, yellow_stained_fence_gate,
			lime_stained_fence_gate, green_stained_fence_gate, cyan_stained_fence_gate;
	public static Block light_blue_stained_fence_gate, blue_stained_fence_gate, purple_stained_fence_gate,
			magenta_stained_fence_gate, brown_stained_fence_gate;
	public static Block black_stained_fence_gate, gray_stained_fence_gate, light_gray_stained_fence_gate,
			white_stained_fence_gate, pink_stained_fence_gate;

	public static Block red_stained_pressure_plate, orange_stained_pressure_plate, yellow_stained_pressure_plate,
			lime_stained_pressure_plate, green_stained_pressure_plate, cyan_stained_pressure_plate,
			light_blue_stained_pressure_plate;
	public static Block blue_stained_pressure_plate, purple_stained_pressure_plate, magenta_stained_pressure_plate,
			brown_stained_pressure_plate, black_stained_pressure_plate, gray_stained_pressure_plate,
			light_gray_stained_pressure_plate;
	public static Block white_stained_pressure_plate, pink_stained_pressure_plate;

	public static Block red_stained_button, orange_stained_button, yellow_stained_button, lime_stained_button,
			green_stained_button, cyan_stained_button, light_blue_stained_button;
	public static Block blue_stained_button, purple_stained_button, magenta_stained_button, brown_stained_button,
			black_stained_button, gray_stained_button, light_gray_stained_button;
	public static Block white_stained_button, pink_stained_button;

	public static Block cedar_pressure_plate, crabapple_pressure_plate, dogwood_pressure_plate,
			jacaranda_pressure_plate, laburnum_pressure_plate, paulownia_pressure_plate, silverbell_pressure_plate,
			wisteria_pressure_plate;
	public static Block acacia_pressure_plate, birch_pressure_plate, oak_pressure_plate, spruce_pressure_plate,
			dark_oak_pressure_plate, jungle_pressure_plate;

	public static Block cedar_button, crabapple_button, dogwood_button, jacaranda_button, laburnum_button,
			paulownia_button, silverbell_button, wisteria_button;
	public static Block acacia_button, birch_button, oak_button, dark_oak_button, spruce_button, jungle_button;
	public static Block vine_wisteria, vine_jacaranda, vine_laburnum, vine_dogwood, vine_crabapple, vine_silverbell,
			vine_paulownia;

	// TODO

	public static Block cedar_trapdoor_1, crabapple_trapdoor_1, dogwood_trapdoor_1, jacaranda_trapdoor_1,
			laburnum_trapdoor_1, paulownia_trapdoor_1, silverbell_trapdoor_1, wisteria_trapdoor_1;

	public static Block acacia_trapdoor_1, birch_trapdoor_1, oak_trapdoor_1, spruce_trapdoor_1, dark_oak_trapdoor_1,
			jungle_trapdoor_1;

	public static Block red_stained_trapdoor_2, orange_stained_trapdoor_2, yellow_stained_trapdoor_2,
			lime_stained_trapdoor_2, green_stained_trapdoor_2, cyan_stained_trapdoor_2, light_blue_stained_trapdoor_2;
	public static Block blue_stained_trapdoor_2, purple_stained_trapdoor_2, magenta_stained_trapdoor_2,
			pink_stained_trapdoor_2, white_stained_trapdoor_2, light_gray_stained_trapdoor_2, gray_stained_trapdoor_2;
	public static Block black_stained_trapdoor_2, brown_stained_trapdoor_2;

	public static Block cedar_trapdoor_2, crabapple_trapdoor_2, dogwood_trapdoor_2, jacaranda_trapdoor_2,
			laburnum_trapdoor_2, paulownia_trapdoor_2, silverbell_trapdoor_2, wisteria_trapdoor_2;

	public static Block acacia_trapdoor_2, birch_trapdoor_2, oak_trapdoor_2, spruce_trapdoor_2, dark_oak_trapdoor_2,
			jungle_trapdoor_2;

	public static Block red_stained_trapdoor_3, orange_stained_trapdoor_3, yellow_stained_trapdoor_3,
			lime_stained_trapdoor_3, green_stained_trapdoor_3, cyan_stained_trapdoor_3, light_blue_stained_trapdoor_3;
	public static Block blue_stained_trapdoor_3, purple_stained_trapdoor_3, magenta_stained_trapdoor_3,
			pink_stained_trapdoor_3, white_stained_trapdoor_3, light_gray_stained_trapdoor_3, gray_stained_trapdoor_3;
	public static Block black_stained_trapdoor_3, brown_stained_trapdoor_3;

	public static Block cedar_trapdoor_3, crabapple_trapdoor_3, dogwood_trapdoor_3, jacaranda_trapdoor_3,
			laburnum_trapdoor_3, paulownia_trapdoor_3, silverbell_trapdoor_3, wisteria_trapdoor_3;

	public static Block acacia_trapdoor_3, birch_trapdoor_3, oak_trapdoor_3, spruce_trapdoor_3, dark_oak_trapdoor_3,
			jungle_trapdoor_3;

	public static Block cedar_trapdoor_4, crabapple_trapdoor_4, dogwood_trapdoor_4, jacaranda_trapdoor_4,
			laburnum_trapdoor_4, paulownia_trapdoor_4, silverbell_trapdoor_4, wisteria_trapdoor_4;

	public static Block acacia_trapdoor_4, birch_trapdoor_4, oak_trapdoor_4, spruce_trapdoor_4, dark_oak_trapdoor_4,
			jungle_trapdoor_4;

	public static Block leaves_jacaranda, leaves_wisteria, leaves_silverbell, leaves_dogwood, leaves_crabapple,
			leaves_paulownia, leaves_laburnum;

	public static Block log_jacaranda, log_wisteria, log_silverbell, log_dogwood, log_crabapple, log_paulownia,
			log_laburnum;

	public static Block sapling_jacaranda, sapling_wisteria, sapling_silverbell, sapling_dogwood, sapling_crabapple,
			sapling_paulownia, sapling_laburnum;

	public static Block sapling_jacaranda_vines, sapling_wisteria_vines, sapling_silverbell_vines,
			sapling_dogwood_vines, sapling_crabapple_vines, sapling_paulownia_vines, sapling_laburnum_vines;
	...
	public static void init() {
		...
		red_large_brick_stairs = new CustomBlockStairs("red_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		orange_large_brick_stairs = new CustomBlockStairs("orange_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		yellow_large_brick_stairs = new CustomBlockStairs("yellow_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		lime_large_brick_stairs = new CustomBlockStairs("lime_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		green_large_brick_stairs = new CustomBlockStairs("green_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		cyan_large_brick_stairs = new CustomBlockStairs("cyan_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		light_blue_large_brick_stairs = new CustomBlockStairs("light_blue_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		blue_large_brick_stairs = new CustomBlockStairs("blue_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		purple_large_brick_stairs = new CustomBlockStairs("purple_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		magenta_large_brick_stairs = new CustomBlockStairs("magenta_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		pink_large_brick_stairs = new CustomBlockStairs("pink_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		white_large_brick_stairs = new CustomBlockStairs("white_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		light_gray_large_brick_stairs = new CustomBlockStairs("light_gray_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		gray_large_brick_stairs = new CustomBlockStairs("gray_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		black_large_brick_stairs = new CustomBlockStairs("black_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		brown_large_brick_stairs = new CustomBlockStairs("brown_large_brick_stairs",
				white_large_brick_block.getDefaultState());
		...
		light_blue_large_brick_slab_double = new CustomBlockDoubleSlab("light_blue_large_brick_slab_double", 2.5F,
				4.5F);
		...
		light_gray_large_brick_slab_double = new CustomBlockDoubleSlab("light_gray_large_brick_slab_double", 2.5F,
				4.5F);
		...
		light_blue_stained_stairs = new CustomBlockStairs("light_blue_stained_stairs",
				whitewashed_planks.getDefaultState());
		...
		light_gray_stained_stairs = new CustomBlockStairs("light_gray_stained_stairs",
				whitewashed_planks.getDefaultState());
	...
	// TODO
	{
		...
		registerBlock(red_brick_slab_half,
				new ItemSlab(red_brick_slab_half, red_brick_slab_half, red_brick_slab_double));
		ForgeRegistries.BLOCKS.register(red_brick_slab_double);

		registerBlock(orange_brick_slab_half,
				new ItemSlab(orange_brick_slab_half, orange_brick_slab_half, orange_brick_slab_double));
		ForgeRegistries.BLOCKS.register(orange_brick_slab_double);

		registerBlock(yellow_brick_slab_half,
				new ItemSlab(yellow_brick_slab_half, yellow_brick_slab_half, yellow_brick_slab_double));
		ForgeRegistries.BLOCKS.register(yellow_brick_slab_double);

		registerBlock(lime_brick_slab_half,
				new ItemSlab(lime_brick_slab_half, lime_brick_slab_half, lime_brick_slab_double));
		ForgeRegistries.BLOCKS.register(lime_brick_slab_double);

		registerBlock(green_brick_slab_half,
				new ItemSlab(green_brick_slab_half, green_brick_slab_half, green_brick_slab_double));
		ForgeRegistries.BLOCKS.register(green_brick_slab_double);

		registerBlock(cyan_brick_slab_half,
				new ItemSlab(cyan_brick_slab_half, cyan_brick_slab_half, cyan_brick_slab_double));
		ForgeRegistries.BLOCKS.register(cyan_brick_slab_double);

		registerBlock(light_blue_brick_slab_half,
				new ItemSlab(light_blue_brick_slab_half, light_blue_brick_slab_half, light_blue_brick_slab_double));
		ForgeRegistries.BLOCKS.register(light_blue_brick_slab_double);

		registerBlock(blue_brick_slab_half,
				new ItemSlab(blue_brick_slab_half, blue_brick_slab_half, blue_brick_slab_double));
		ForgeRegistries.BLOCKS.register(blue_brick_slab_double);

		registerBlock(purple_brick_slab_half,
				new ItemSlab(purple_brick_slab_half, purple_brick_slab_half, purple_brick_slab_double));
		ForgeRegistries.BLOCKS.register(purple_brick_slab_double);

		registerBlock(magenta_brick_slab_half,
				new ItemSlab(magenta_brick_slab_half, magenta_brick_slab_half, magenta_brick_slab_double));
		ForgeRegistries.BLOCKS.register(magenta_brick_slab_double);

		registerBlock(pink_brick_slab_half,
				new ItemSlab(pink_brick_slab_half, pink_brick_slab_half, pink_brick_slab_double));
		ForgeRegistries.BLOCKS.register(pink_brick_slab_double);

		registerBlock(white_brick_slab_half,
				new ItemSlab(white_brick_slab_half, white_brick_slab_half, white_brick_slab_double));
		ForgeRegistries.BLOCKS.register(white_brick_slab_double);

		registerBlock(light_gray_brick_slab_half,
				new ItemSlab(light_gray_brick_slab_half, light_gray_brick_slab_half, light_gray_brick_slab_double));
		ForgeRegistries.BLOCKS.register(light_gray_brick_slab_double);

		registerBlock(gray_brick_slab_half,
				new ItemSlab(gray_brick_slab_half, gray_brick_slab_half, gray_brick_slab_double));
		ForgeRegistries.BLOCKS.register(gray_brick_slab_double);

		registerBlock(black_brick_slab_half,
				new ItemSlab(black_brick_slab_half, black_brick_slab_half, black_brick_slab_double));
		ForgeRegistries.BLOCKS.register(black_brick_slab_double);

		registerBlock(brown_brick_slab_half,
				new ItemSlab(brown_brick_slab_half, brown_brick_slab_half, brown_brick_slab_double));
		...
		registerBlock(red_large_brick_slab_half,
				new ItemSlab(red_large_brick_slab_half, red_large_brick_slab_half, red_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(red_large_brick_slab_double);

		registerBlock(orange_large_brick_slab_half, new ItemSlab(orange_large_brick_slab_half,
				orange_large_brick_slab_half, orange_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(orange_large_brick_slab_double);

		registerBlock(yellow_large_brick_slab_half, new ItemSlab(yellow_large_brick_slab_half,
				yellow_large_brick_slab_half, yellow_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(yellow_large_brick_slab_double);

		registerBlock(lime_large_brick_slab_half,
				new ItemSlab(lime_large_brick_slab_half, lime_large_brick_slab_half, lime_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(lime_large_brick_slab_double);

		registerBlock(green_large_brick_slab_half,
				new ItemSlab(green_large_brick_slab_half, green_large_brick_slab_half, green_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(green_large_brick_slab_double);

		registerBlock(cyan_large_brick_slab_half,
				new ItemSlab(cyan_large_brick_slab_half, cyan_large_brick_slab_half, cyan_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(cyan_large_brick_slab_double);

		registerBlock(light_blue_large_brick_slab_half, new ItemSlab(light_blue_large_brick_slab_half,
				light_blue_large_brick_slab_half, light_blue_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(light_blue_large_brick_slab_double);

		registerBlock(blue_large_brick_slab_half,
				new ItemSlab(blue_large_brick_slab_half, blue_large_brick_slab_half, blue_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(blue_large_brick_slab_double);

		registerBlock(purple_large_brick_slab_half, new ItemSlab(purple_large_brick_slab_half,
				purple_large_brick_slab_half, purple_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(purple_large_brick_slab_double);

		registerBlock(magenta_large_brick_slab_half, new ItemSlab(magenta_large_brick_slab_half,
				magenta_large_brick_slab_half, magenta_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(magenta_large_brick_slab_double);

		registerBlock(pink_large_brick_slab_half,
				new ItemSlab(pink_large_brick_slab_half, pink_large_brick_slab_half, pink_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(pink_large_brick_slab_double);

		registerBlock(white_large_brick_slab_half,
				new ItemSlab(white_large_brick_slab_half, white_large_brick_slab_half, white_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(white_large_brick_slab_double);

		registerBlock(light_gray_large_brick_slab_half, new ItemSlab(light_gray_large_brick_slab_half,
				light_gray_large_brick_slab_half, light_gray_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(light_gray_large_brick_slab_double);

		registerBlock(gray_large_brick_slab_half,
				new ItemSlab(gray_large_brick_slab_half, gray_large_brick_slab_half, gray_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(gray_large_brick_slab_double);

		registerBlock(black_large_brick_slab_half,
				new ItemSlab(black_large_brick_slab_half, black_large_brick_slab_half, black_large_brick_slab_double));
		ForgeRegistries.BLOCKS.register(black_large_brick_slab_double);

		registerBlock(brown_large_brick_slab_half,
				new ItemSlab(brown_large_brick_slab_half, brown_large_brick_slab_half, brown_large_brick_slab_double));
		...
		registerBlock(crabapple_slab_half,
				new ItemSlab(crabapple_slab_half, crabapple_slab_half, crabapple_slab_double));
		...
		registerBlock(jacaranda_slab_half,
				new ItemSlab(jacaranda_slab_half, jacaranda_slab_half, jacaranda_slab_double));
		...
		registerBlock(paulownia_slab_half,
				new ItemSlab(paulownia_slab_half, paulownia_slab_half, paulownia_slab_double));
		ForgeRegistries.BLOCKS.register(paulownia_slab_double);
		registerBlock(silverbell_slab_half,
				new ItemSlab(silverbell_slab_half, silverbell_slab_half, silverbell_slab_double));
		...
		registerBlock(whitewashed_slab_half,
				new ItemSlab(whitewashed_slab_half, whitewashed_slab_half, whitewashed_slab_double));
		...
		registerBlock(red_stained_slab_half,
				new ItemSlab(red_stained_slab_half, red_stained_slab_half, red_stained_slab_double));
		ForgeRegistries.BLOCKS.register(red_stained_slab_double);

		registerBlock(orange_stained_slab_half,
				new ItemSlab(orange_stained_slab_half, orange_stained_slab_half, orange_stained_slab_double));
		ForgeRegistries.BLOCKS.register(orange_stained_slab_double);

		registerBlock(yellow_stained_slab_half,
				new ItemSlab(yellow_stained_slab_half, yellow_stained_slab_half, yellow_stained_slab_double));
		ForgeRegistries.BLOCKS.register(yellow_stained_slab_double);

		registerBlock(lime_stained_slab_half,
				new ItemSlab(lime_stained_slab_half, lime_stained_slab_half, lime_stained_slab_double));
		ForgeRegistries.BLOCKS.register(lime_stained_slab_double);

		registerBlock(green_stained_slab_half,
				new ItemSlab(green_stained_slab_half, green_stained_slab_half, green_stained_slab_double));
		ForgeRegistries.BLOCKS.register(green_stained_slab_double);

		registerBlock(cyan_stained_slab_half,
				new ItemSlab(cyan_stained_slab_half, cyan_stained_slab_half, cyan_stained_slab_double));
		ForgeRegistries.BLOCKS.register(cyan_stained_slab_double);

		registerBlock(light_blue_stained_slab_half, new ItemSlab(light_blue_stained_slab_half,
				light_blue_stained_slab_half, light_blue_stained_slab_double));
		ForgeRegistries.BLOCKS.register(light_blue_stained_slab_double);

		registerBlock(blue_stained_slab_half,
				new ItemSlab(blue_stained_slab_half, blue_stained_slab_half, blue_stained_slab_double));
		ForgeRegistries.BLOCKS.register(blue_stained_slab_double);

		registerBlock(purple_stained_slab_half,
				new ItemSlab(purple_stained_slab_half, purple_stained_slab_half, purple_stained_slab_double));
		ForgeRegistries.BLOCKS.register(purple_stained_slab_double);

		registerBlock(magenta_stained_slab_half,
				new ItemSlab(magenta_stained_slab_half, magenta_stained_slab_half, magenta_stained_slab_double));
		ForgeRegistries.BLOCKS.register(magenta_stained_slab_double);

		registerBlock(pink_stained_slab_half,
				new ItemSlab(pink_stained_slab_half, pink_stained_slab_half, pink_stained_slab_double));
		ForgeRegistries.BLOCKS.register(pink_stained_slab_double);

		registerBlock(white_stained_slab_half,
				new ItemSlab(white_stained_slab_half, white_stained_slab_half, white_stained_slab_double));
		ForgeRegistries.BLOCKS.register(white_stained_slab_double);

		registerBlock(light_gray_stained_slab_half, new ItemSlab(light_gray_stained_slab_half,
				light_gray_stained_slab_half, light_gray_stained_slab_double));
		ForgeRegistries.BLOCKS.register(light_gray_stained_slab_double);

		registerBlock(gray_stained_slab_half,
				new ItemSlab(gray_stained_slab_half, gray_stained_slab_half, gray_stained_slab_double));
		ForgeRegistries.BLOCKS.register(gray_stained_slab_double);

		registerBlock(black_stained_slab_half,
				new ItemSlab(black_stained_slab_half, black_stained_slab_half, black_stained_slab_double));
		ForgeRegistries.BLOCKS.register(black_stained_slab_double);

		registerBlock(brown_stained_slab_half,
				new ItemSlab(brown_stained_slab_half, brown_stained_slab_half, brown_stained_slab_double));
