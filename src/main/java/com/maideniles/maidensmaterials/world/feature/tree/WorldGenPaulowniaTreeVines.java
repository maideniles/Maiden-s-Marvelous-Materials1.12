...
public class WorldGenPaulowniaTreeVines extends WorldGenAbstractTree
{
    ...
    public WorldGenPaulowniaTreeVines(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 4, LOG, LEAF, false, p_i2027_1_);
    }

    public WorldGenPaulowniaTreeVines(boolean notify, int minTreeHeightIn, IBlockState woodMeta, IBlockState p_i46446_4_, boolean growVines, boolean useExtraRandomHeightIn)
    {
        super(notify);
