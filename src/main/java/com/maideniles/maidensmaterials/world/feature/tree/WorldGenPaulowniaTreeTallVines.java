...
{
    private static final IBlockState LOG = BlockInit.log_paulownia.getDefaultState();
    private static final IBlockState LEAF = BlockInit.leaves_paulownia.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    ...
    {
        this.setBlockAndNotifyAdequately(worldIn, pos, BlockInit.vine_paulownia.getDefaultState().withProperty(prop, Boolean.valueOf(true)));
    }
