...
public class WorldGenJacarandaTree extends WorldGenAbstractTree
{
    ...
    private static final IBlockState LEAF = MaidensBlocks.leaves_jacaranda.getDefaultState();
    private final boolean useExtraRandomHeight;

    public WorldGenJacarandaTree(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
