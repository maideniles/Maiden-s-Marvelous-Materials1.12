...
{
    private static final IBlockState LOG = BlockInit.log_silverbell.getDefaultState();
    private static final IBlockState LEAF = BlockInit.leaves_silverbell.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    ...
    {
        this.setBlockAndNotifyAdequately(worldIn, pos, BlockInit.vine_silverbell.getDefaultState().withProperty(prop, Boolean.valueOf(true)));
    }
