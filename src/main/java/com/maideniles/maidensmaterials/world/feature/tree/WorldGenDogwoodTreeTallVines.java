...
public class WorldGenDogwoodTreeTallVines extends WorldGenAbstractTree
{
    private static final IBlockState LOG = MaidensBlocks.log_dogwood.getDefaultState();
    private static final IBlockState LEAF = MaidensBlocks.leaves_dogwood.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    ...
    public WorldGenDogwoodTreeTallVines(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 4, LOG, LEAF, false, p_i2027_1_);
    }

    public WorldGenDogwoodTreeTallVines(boolean notify, int minTreeHeightIn, IBlockState woodMeta, IBlockState p_i46446_4_, boolean growVines, boolean useExtraRandomHeightIn)
    {
        super(notify);
    ...
    {
        this.setBlockAndNotifyAdequately(worldIn, pos, MaidensBlocks.vine_dogwood.getDefaultState().withProperty(prop, Boolean.valueOf(true)));
    }
