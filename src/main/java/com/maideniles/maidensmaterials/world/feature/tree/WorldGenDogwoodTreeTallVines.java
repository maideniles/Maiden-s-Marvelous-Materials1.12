...
{
    private static final IBlockState LOG = BlockInit.log_dogwood.getDefaultState();
    private static final IBlockState LEAF = BlockInit.leaves_dogwood.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    ...
    {
        this.setBlockAndNotifyAdequately(worldIn, pos, BlockInit.vine_dogwood.getDefaultState().withProperty(prop, Boolean.valueOf(true)));
    }
