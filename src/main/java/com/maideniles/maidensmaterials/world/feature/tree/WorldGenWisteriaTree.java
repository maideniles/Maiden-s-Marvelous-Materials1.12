...
public class WorldGenWisteriaTree extends WorldGenAbstractTree
{
    private static final IBlockState LOG = MaidensBlocks.log_wisteria.getDefaultState();
    private static final IBlockState LEAF = MaidensBlocks.leaves_wisteria.getDefaultState();
    private final boolean useExtraRandomHeight;

    public WorldGenWisteriaTree(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
