...
public class WorldGenCrabappleTreeTallVines extends WorldGenAbstractTree
{
    ...
    private static final IBlockState LEAF = BlockInit.leaves_crabapple.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    ...
    {
        this.setBlockAndNotifyAdequately(worldIn, pos, BlockInit.vine_crabapple.getDefaultState().withProperty(prop, Boolean.valueOf(true)));
    }
