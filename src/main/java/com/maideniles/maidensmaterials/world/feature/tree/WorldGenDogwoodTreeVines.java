...
public class WorldGenDogwoodTreeVines extends WorldGenAbstractTree
{
    ...
    public WorldGenDogwoodTreeVines(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 4, LOG, LEAF, false, p_i2027_1_);
    }

    public WorldGenDogwoodTreeVines(boolean notify, int minTreeHeightIn, IBlockState woodMeta, IBlockState p_i46446_4_, boolean growVines, boolean useExtraRandomHeightIn)
    {
        super(notify);
