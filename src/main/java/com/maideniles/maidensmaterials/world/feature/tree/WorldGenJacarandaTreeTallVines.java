...
{
    private static final IBlockState LOG = BlockInit.log_jacaranda.getDefaultState();
    private static final IBlockState LEAF = BlockInit.leaves_jacaranda.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    ...
    {
        this.setBlockAndNotifyAdequately(worldIn, pos, BlockInit.vine_jacaranda.getDefaultState().withProperty(prop, Boolean.valueOf(true)));
    }
